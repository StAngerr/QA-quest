var x = "src/images/x.gif";var o = "src/images/o.gif";
var blank = "src/images/z.gif";var pause = 0;var all = 0;var a = 0;var b = 0;
...
function taken() {alert("no empty place")
pause=1;}
function myChoice() {
...
process();}
function ended() {alert("press button to start new game")}
function process() {
logicOne();
if (all==1){ alert("You've won!"); wn++; }
if (all==2){ alert("You've lost"); ls++; }
